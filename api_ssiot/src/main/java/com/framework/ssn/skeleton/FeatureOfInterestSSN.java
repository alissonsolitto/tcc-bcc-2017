 ...
 */
public class FeatureOfInterestSSN {

    private final OntologyFramework OntologyFramework;
    private String typeName;
    private OntModel model;
   
    public FeatureOfInterestSSN(OntModel model){
        this.model = model;
        this.OntologyFramework = new OntologyFramework();
        this.typeName = "FeatureOfInterest";
    ...
    public void AddFeatureOfInterestInd(String name, String descComment, String descLabel){
        try {
            OntologyFramework.AddIndividualSSN(this.model, name, this.typeName, descComment, descLabel);
        } catch (Exception ex) {
            System.err.println("Erro no método AddFeatureOfInterestInd => " + ex.getMessage());
        }        
    }
